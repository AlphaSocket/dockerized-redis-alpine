...
ADD bin/setup /usr/local/bin/setup/1517136995
ADD bin/config /usr/local/bin/config/1517136995
ADD imports/templates /usr/local/templates

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517136995 
...
LABEL \
    org.label-schema.vcs-ref=236ccab \
