...
ADD bin/setup /usr/local/bin/setup/1517107118
ADD bin/config /usr/local/bin/config/1517107118
ADD imports/templates /usr/local/templates

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517107118 
...
LABEL \
    org.label-schema.vcs-ref=ebb41a4 \
