...
ADD imports/bin/setup /usr/local/bin/setup/1519588934
ADD imports/bin/config /usr/local/bin/config/1519588934
ADD imports/templates/redis.conf /usr/local/templates/redis.conf


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519588934 1>/dev/stdout 2>/dev/stderr
