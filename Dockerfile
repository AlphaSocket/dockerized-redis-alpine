...
ADD bin/setup /usr/local/bin/setup/1517108337
ADD bin/config /usr/local/bin/config/1517108337
ADD imports/templates /usr/local/templates

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517108337 
...
LABEL \
    org.label-schema.vcs-ref=1f6c6d0 \
