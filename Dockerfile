...
ADD bin/setup /usr/local/bin/setup/1517105208
ADD bin/config /usr/local/bin/config/1517105208
ADD imports/templates /usr/local/templates

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517105208 
...
LABEL \
    org.label-schema.vcs-ref=6de7a27 \
