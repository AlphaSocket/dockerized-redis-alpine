...
ADD bin/setup /usr/local/bin/setup/1517022222
ADD bin/config /usr/local/bin/config/1517022222

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517022222 
...
LABEL \
    org.label-schema.vcs-ref=8ae77a5 \
