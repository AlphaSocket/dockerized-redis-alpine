...
ADD bin/setup /usr/local/bin/setup/1517106255
ADD bin/config /usr/local/bin/config/1517106255
ADD imports/templates /usr/local/templates

RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1517106255 
...
LABEL \
    org.label-schema.vcs-ref=745661f \
